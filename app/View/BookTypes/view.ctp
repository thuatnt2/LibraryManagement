...
<h2><?php echo __('Book Type'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($bookType['BookType']['description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Book Type'), array('action' => 'delete', $bookType['BookType']['id']), null, __('Are you sure you want to delete # %s?', $bookType['BookType']['id'])); ?> </li>
