<div class="bookCategories view">
<h2><?php echo __('Book Category'); ?></h2>
	<dl>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($bookCategory['BookCategory']['id']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Name'); ?></dt>
		<dd>
			<?php echo h($bookCategory['BookCategory']['name']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Description'); ?></dt>
		<dd>
			<?php echo h($bookCategory['BookCategory']['description']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		<li><?php echo $this->Html->link(__('Edit Book Category'), array('action' => 'edit', $bookCategory['BookCategory']['id'])); ?> </li>
		<li><?php echo $this->Form->postLink(__('Delete Book Category'), array('action' => 'delete', $bookCategory['BookCategory']['id']), null, __('Are you sure you want to delete # %s?', $bookCategory['BookCategory']['id'])); ?> </li>
		<li><?php echo $this->Html->link(__('List Book Categories'), array('action' => 'index')); ?> </li>
		<li><?php echo $this->Html->link(__('New Book Category'), array('action' => 'add')); ?> </li>
...
<div class="related">
	...
	<?php if (!empty($bookCategory['Book'])): ?>
	...
	<?php foreach ($bookCategory['Book'] as $book): ?>
		<tr>
			...
			<td><?php echo $book['language_di']; ?></td>
