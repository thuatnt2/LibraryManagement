...
<?php echo $this->Form->create('Ciculation'); ?>
	<fieldset>
		<legend><?php echo __('Edit Ciculation'); ?></legend>
	<?php
...
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $this->Form->value('Ciculation.id')), null, __('Are you sure you want to delete # %s?', $this->Form->value('Ciculation.id'))); ?></li>
