                    ...
                    <div class="um_box_mid_content_mid_left">
                        ...
                        <div class="um_box_mid_content_mid_right" align="right">
                               ...
                               <div>
                                   ...
                                   <div class="umstyle4" ><?php echo $this->Form->input("price", array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control')) ?></div>
                                   <div style="clear:both"></div>
                               </div>
                                <div>
                                    <div class="umstyle3"><?php echo 'Vị trí đặt sách'; ?><font color='red'>*</font></div>
                                    <div class="umstyle4" ><?php echo $this->Form->input("location", array('type' => 'text', 'label' => false, 'div' => false, 'class' => 'form-control')) ?></div>
                                    <div style="clear:both"></div>
                                </div>
                                                    <div>
